<script>
  import bookCover from "$assets/wisemen.jpg"
  import phoneCover from "$assets/truffles.jpeg"
...
<section class="hero">
  <div class="hero-showcase text-center bold">
    ...
    <h1 class="purple mb-xs">AFRICA</h1>
  ...
  <div class="hero-text white text-center">
    ...
    {:else}
      ...
      <p class="light-grey mb-l">
        I moved to Africa two years ago.  The process was painful and difficult. I 
        learned most things the hard way: finding a job, getting a visa, 
        calculating my cost of living, choosing an apartment. Tha's why I wrote 
