<script>
  import authorPic from '$assets/BellesFeet.jpeg'
</script>
...
<section class="landing-page-section">
  ...
  <div class="author-container">
    <div class="author-text">
      <p class="mb-xs">
        Delane Jackson is a seasoned expatriate with over seven years of
        ...
        <p>
        Delanes practical advice is rooted in real-life experience, having
    ...
    <img src={authorPic} alt="Author Delane Jackson" />
  </div>
</section>
